...
def worker(data_path, shape_name, num_point, save_path):
...
def mesh2pc(num_point,mode,base_data_path, pool):
    #num_point=20000
    #mode='train'
    ...
    for shape_name in shape_name_list:
        pool.apply_async(worker, (data_path, shape_name, num_point, save_path))

if __name__=='__main__':
    base_data_path='/home/aryan/baselines/PUGeo/mesh'
    ...
    for num_point in num_point_list:
        ...
        for mode in mode_list:
            mesh2pc(num_point, mode, base_data_path, pool)
